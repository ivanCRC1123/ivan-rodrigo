...
- Estados de Pedido (PENDIENTE, CONFIRMADO, EN_PREPARACION, ENTREGADO, CANCELADO)
...
def seed_pedido_enums(session: Session) -> None:
    ...
    - TRANSFERENCIA
    """
    print(" Estados de Pedido registrados: PENDIENTE, CONFIRMADO, EN_PREPARACION, ENTREGADO, CANCELADO")
    print(" Formas de Pago registradas: MERCADO_PAGO, EFECTIVO, TRANSFERENCIA")
